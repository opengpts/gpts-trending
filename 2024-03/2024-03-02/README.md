...
# Today's Trending - 2024-03/2024-03-02
...
- [Keymate.AI Search GPT](https://chat.openai.com/g/g-veSrMmasJ-keymate-ai-search-gpt) All in one GPT: 10X Browsing Links with Google Search + multi PDF + AI Knowledge Memory + Academic (395M+ Up to Date Publications) + Hallucination Check + API and more
...
- [ロMidjourney Prompt Generator (V6)](https://chat.openai.com/g/g-tc0eHXdgb-romidjourney-prompt-generator-v6) Generate 5 detailed, creative, optimized prompts that are ready to use in Midjourney V6. Mention "niji" if you need ending with "--niji 6"
- [Mid Journey V6 Prompt Creator](https://chat.openai.com/g/g-vd364I1Zi-mid-journey-v6-prompt-creator) Over 20 hours of training went into developing the BEST Midjourney V6 image prompt creator tool on the planet...
- [Artful Greeting AI Cards](https://chat.openai.com/g/g-SnF78wo4p-artful-greeting-ai-cards) Customizable themed greeting cards with optional text.
- [DALL - E Next Level Images](https://chat.openai.com/g/g-vmGPg298v-dall-e-next-level-images) Generate Top-notch, High Quality Images Using DALL-E With Guided Prompts
...
- [PowerPoint](https://chat.openai.com/g/g-0gFt7qej4-powerpoint) Creates High Quality Presentations.
...
- [DIAGRAM ⚡PRO⚡](https://chat.openai.com/g/g-jBdvgesNC-diagram-pro) Mindmaps, Databases, Flowcharts, Charts. ⚡Drag-N-Drop⚡ Edit.
...
- [math](https://chat.openai.com/g/g-odWlfAKWM-math) The world's most powerful math tutor.
...
- [fashion](https://chat.openai.com/g/g-rr7AytfKH-fashion) Aurra, your AI Fashion Assistant, created by Nova Lorraine
