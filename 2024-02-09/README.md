...
- [Whimsical Diagrams](https://chat.openai.com/g/g-vI2kaiM9N-whimsical-diagrams) Explains and visualizes concepts with Whimsical Flowcharts, Mindmaps and Sequence Diagrams.
- [SEO](https://chat.openai.com/g/g-GrshPDvS3-seo) Enter any URL and keyword and get an On-Page SEO analysis & insights!
- [Keymate.AI GPT](https://chat.openai.com/g/g-veSrMmasJ-keymate-ai-gpt) NEW: All in one Research: Chat with full-text paper (Load via DOI from 395 M+ papers)  + 10X Better Browsing with Google Search + multi PDF chat + Personalized Long Term AI Memory + API and more
